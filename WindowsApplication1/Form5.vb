...
Public Class Form5
    ...
    Public Sub ELIMINAR()
        If conexion.State = ConnectionState.Closed Then
            conexion.Open()
        End If
        If Comboano.Text = "06/21 en adelante" Then
            ...
            End If
        End If
        If Comboano.Text = "05/20 al 05/21" Then
            MsgBox("¿Desea eliminar registro?", vbYesNo, "Eliminar")
            If vbYes Then
                ...
                MOSTRAR2()
            Else
                MsgBox("Registro NO eliminado", MsgBoxStyle.Information, "Confirmar")
                MOSTRAR2()
            End If
        End If
        If conexion.State = ConnectionState.Open Then
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If conexion.State = ConnectionState.Closed Then
            conexion.Open()
        End If
        If Comboano.Text = "05/20 a 05/21" Then
            Try
                ACTUALIZAR = "UPDATE victimas SET Clave_ID= '" & CLAVE_ID.Text &
        "', NombreVictima='" & nombrev.Text &
              "', EdadVictima='" & edadv.Text &
              "', DireccionVictima='" & direv.Text &
               "', DniVictima='" & dniv.Text &
              "', TelefonoVictima='" & telv.Text &
              "', ProfesionVictima='" & polv.Text &
               "',DestinoVictima='" & destv.Text &
              "', JerarquiaVictima='" & jerv.Text &
              "', LegajoVictima='" & legv.Text &
               "', OtroVictima='" & otrov.Text &
                        "' WHERE Clave_ID= '" & CLAVE_ID.Text & "' "
            ...
            Catch ex As Exception
                ...
                conexion.Close()
            End Try
        ElseIf Comboano.Text = "06/21 en adelante" Then
            Try
                ACTUALIZAR = "UPDATE victima SET Clave_ID= '" & CLAVE_ID.Text &
        "', NombreVictima='" & nombrev.Text &
              "', EdadVictima='" & edadv.Text &
              "', DireccionVictima='" & direv.Text &
               "', DniVictima='" & dniv.Text &
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If Comboano.Text = "05/20 a 05/21" Then
            Try
                ACTUALIZAR = "UPDATE imputados SET Clave_ID= '" & CLAVE_ID.Text &
        "', NombreDenunciado='" & nombrei.Text &
              "', EdadDenunciado='" & edadi.Text &
              "', DireccionDenunciado='" & direi.Text &
               "', DniDenunciado='" & dnii.Text &
              "', TelefonoDenunciado='" & teli.Text &
              "', ProfesionDenunciado='" & poli.Text &
               "',DestinoDenunciado='" & desti.Text &
              "', JerarquiaDenunciado='" & jeri.Text &
              "', LegajoDenunciado='" & legi.Text &
               "', OtroDenunciado='" & otroi.Text &
                        "' WHERE Clave_ID= '" & CLAVE_ID.Text & "' "
                comandos = New MySqlCommand(ACTUALIZAR, conexion)
                comandos.ExecuteNonQuery()
                MsgBox("Se modifico correctamente", vbInformation, "AVISO")
        ...
        ElseIf Comboano.Text = "06/21 en adelante" Then
            Try
                ACTUALIZAR = "UPDATE imputado SET Clave_ID= '" & CLAVE_ID.Text &
        "', NombreDenunciado='" & nombrei.Text &
              "', EdadDenunciado='" & edadi.Text &
              "', DireccionDenunciado='" & direi.Text &
               "', DniDenunciado='" & dnii.Text &
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If Comboano.Text = "05/20 a 05/21" Then
            Try
                ACTUALIZAR = "UPDATE seguimiento SET Clave_Id= '" & CLAVE_ID.Text &
         "', Fecha='" & FECHA.Text &
       "', Conocimiento='" & CONOCIMIENTO.Text &
       "', Caratula='" & CARATULA.Text &
       "', Antecedentes='" & ANTECEDENTES.Text &
       "', Alojamiento='" & ALOJAMIENTO.Text &
       "', Grupo='" & GRUPO.Text &
       "', Medida='" & MEDIDA.Text &
       "', Cual='" & CUAL.Text &
       "', Obsme='" & OBSME.Text &
    ...
    "', Seguimiento='" & SEGUIMIENTO.Text &
        ...
        ElseIf Comboano.Text = "06/21 en adelante" Then
            Try
                ACTUALIZAR = "UPDATE registro SET Clave_Id= '" & CLAVE_ID.Text &
         "', Fecha='" & FECHA.Text &
       "', Conocimiento='" & CONOCIMIENTO.Text &
       "', Caratula='" & CARATULA.Text &
       "', Antecedentes='" & ANTECEDENTES.Text &
    ...
    Private Sub IMPRIMIR_Click(sender As Object, e As EventArgs) Handles IMPRIMIR.Click
        ...
        Documento.Bookmarks.Item("OtroVictima").Range.Text = otrov.Text
        ...
        Documento.Bookmarks.Item("OtroDenunciado").Range.Text = otroi.Text
